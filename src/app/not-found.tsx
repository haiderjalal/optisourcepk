 ...
 * Global 404.
 *
 * Must stay at `app/` — a `not-found.tsx` inside the `(site)` route group
 * would not serve unmatched URLs — so it carries the site chrome itself
 * rather than inheriting it from `(site)/layout.tsx`.
 */
